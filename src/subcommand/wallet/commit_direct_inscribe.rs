...
#[derive(Debug, Parser)]
pub(crate) struct CommitDirectInscribe {
    #[arg(
    long,
    default_value = "",
...
impl CommitDirectInscribe {
    fn bytes_from_hex_string(hex_str: &str) -> crate::Result<[u8; 32], &'static str> {
        if hex_str.len() != 64 {
    ...
    fn key_pair_from_str(key: &str) -> crate::Result<(Secp256k1<All>, KeyPair)> {
